...
export default class RemoteDecreaseProductQuantity implements DecreaseProductQuantity {
  ...
  async decreaseQuantity(product: Product, aboutCart: string): Promise<Cart> {
